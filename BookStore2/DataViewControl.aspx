    ...
    <div>
        ...
        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" CellPadding="4" DataKeyNames="BookId" DataSourceID="SqlDataSource4" ForeColor="#333333">
            ...
            <ItemTemplate>
                ...
                <br />
                ImageUrl:
                 <asp:Image ID="Image1" Height="50"  runat="server" ImageUrl='<%#Eval("ImageUrl") %>'/>
                <br />
                GenreId:
        ...
        <h3>Datalist</h3>
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource5" DataKeyField="BookId" CellPadding="4" ForeColor="#333333" RepeatColumns="4">
...
<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" SelectCommand="SELECT * FROM [Product] ORDER BY [BookName]"></asp:SqlDataSource>
    </div>
</asp:Content>
